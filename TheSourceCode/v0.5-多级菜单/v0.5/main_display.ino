...
void mainDisplay()
{
  ...
  if (main_display_state == 1)
  {
    ...
    show_string("Sleep:", 0,  y * 7, 2, RED, BLACK, 1);
    show_string("Set", 150,  219, 3, YELLOW, BLACK, 1);
    if (t12_switch == 0)
    {
  ...
  show_number_int(digitalRead(sleep_pin), 130, y * 7, 2, BLUE, BLACK  , 0);
  show_number_int(t12_temp_read_time, 130, y * 8, 2, BLUE, BLACK  , 0);
