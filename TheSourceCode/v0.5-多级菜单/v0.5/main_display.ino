...
void mainDisplay()
{
  ...
  if (main_display_state == 1)
  {
    ...
    if (t12_switch == 0)
    {
      ...
      show_string("OFF", 250,  188, 3, RED, BLACK, 1);
    }
    else if (t12_switch == 1)
    {
      show_string("ON", 250,  144, 3, RED, BLACK, 1);
  ...
  show_number_float(1, ntc_temp, 130, y * 2, 2, fc2, BLACK  , 0);
  show_number_int(set_temp, 130, y * 3, 2, fc2, BLACK  , 0);
  show_number_float(1, volage, 130, y * 4, 2, fc2, BLACK  , 0);
  show_number_float(1, ec, 130, y * 5, 2, fc2, BLACK  , 0);
  show_number_int(pid_out, 130, y * 6, 2, fc2, BLACK  , 0);
  show_number_int(digitalRead(sleep_pin), 130, y * 7, 2, fc2, BLACK  , 0);
