...
void show_number_int_0(long num, int16_t x, int16_t y, uint8_t csize, uint16_t fc, uint16_t bc, boolean mode0)
{
  mylcd.Set_Text_Mode(mode0);
  mylcd.Set_Text_Size(csize);
  mylcd.Set_Text_colour(fc);
  mylcd.Set_Text_Back_colour(bc);
  mylcd.Print_Number_Int(num, x, y, 4, '0', 10);
}
void show_number_int_5(long num, int16_t x, int16_t y, uint8_t csize, uint16_t fc, uint16_t bc, boolean mode0)
{
  mylcd.Set_Text_Mode(mode0);
  mylcd.Set_Text_Size(csize);
  mylcd.Set_Text_colour(fc);
...
void show_number_float(double num, int16_t x, int16_t y, uint8_t csize, uint16_t fc, uint16_t bc, boolean mode0)
{
  ...
  mylcd.Set_Text_colour(fc);
  mylcd.Set_Text_Back_colour(bc);
  mylcd.Print_Number_Float(num,0, x, y, '.', 0, ' ');
}
